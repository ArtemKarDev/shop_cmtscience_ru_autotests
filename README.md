...
│           │   ├── BaseTest.java
│           │   ├── LoginTests.java
│           │   ├── CatalogPageTests.java
│           │   ├── RegisterTests.java
│           │   └── ProductModalTests.java         
│           │
│           └── pages/
│               ├── CatalogPage.java
│               ├── RegisterPage.java
...
**Тестирование регистрации (`/register`):**
*   ✓ Попытка регистрации — появление ошибки капчи (антибот)

**Тестирование логина:**
*   ✓ Успешный логин через модальное окно

**Тестирование каталога (`/catalog`):**
*   ✓ Выбор товара по наименованию и проверка данных 
*   ✓ Добавление в корзину через модальное окно выбора вкуса
*   ✓ Переход на страницу товара из каталога
*   ✓ Проверка наличия товаров в каталоге с фильром

**Тестирование модального меню товара:**
*   ✓ Изменение количества товара c 1 на 0 - появляется кнопка Корзина
*   ✓ Проверка доступных вариантов вкусов
*   ✓ Проверка загрузки модального окна выбора вкуса
